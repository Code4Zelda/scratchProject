...
class App extends React.Component {
    ...
    /**
     * Also checks if the users exist/redirects users to home page
     * @param {Object} event - Login in user and sends info to the database
     */
    ...
    /**
     * it sends request to the server to upload a picture
     * @param {Object} event Object with picture info
     */
    ...
    /**
     * changes users state 
     * @param {Object} event - track state of username 
     */
    ...
    /**
     * 
     * @param {Object} event - handles state of password  
     */
    ...
    /**
     * tracks state of text
     * @param {Object} event - sends text to database once user uploads pic
     */
    ...
    /**
     * handler to send user to upload page
     */
    handleLoader() {
        history.push('/home/upload');
    }
    /**
     * handler to send user back to the home page after they have uploaded and sumbit image
     * the "X" at the right sends user back to home page.
     * changes state back to false and empty string
     */
    ...
    /** 
     * handles the 'Nightout' button to let user know it has be click
     */
    ...
    /**
     * handles the 'Outdoor' button to let user know it has be click
     * changes state back to true or false depeneding on what the users pick
     */
